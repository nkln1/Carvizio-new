...
export default function Contact() {
  ...
  // Schema pentru datele structurate ale paginii de contact
  const contactSchema = {
    type: 'ContactPage' as const,
    data: {
      '@context': 'https://schema.org',
      '@type': 'ContactPage',
      name: 'Contactează Carvizio',
      description: 'Ai întrebări sau sugestii? Scrie-ne un mesaj și îți vom răspunde cât mai curând posibil.',
      contactPoint: {
        '@type': 'ContactPoint',
        telephone: '0712 345 678',
        email: 'contact@carvizio.com',
        contactType: 'customer service'
      },
      url: 'https://auto-service-app.ro/contact'
    }
  };
  ...
  return (
    <>
      ...
      <SEOHeader 
        title="Contactează-ne | CARVIZIO - Platformă Service Auto"
        description="Ai întrebări despre serviciile noastre auto sau nevoie de asistență? Contactează-ne și echipa noastră îți va răspunde cât mai curând."
        keywords="contact service auto, asistență Carvizio, întrebări service auto, asistență tehnică mașini"
        canonicalUrl="https://auto-service-app.ro/contact"
        ogImage="/og-contact.jpg"
        lang="ro"
      />
      
      {/* Datele structurate pentru pagina de contact */}
      <StructuredData schema={contactSchema as any} />

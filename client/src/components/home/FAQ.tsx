...
// Date FAQ pentru ambele scopuri: afișare și structurare pentru SEO
const faqs = [
  {
  ...
  },
  {
    ...
    answer:
    'După ce ai ales o ofertă, apelează sau trimite un mesaj service-ului prin sistemul de mesagerie integrat în platformă pentru a stabili toate detaliile programării.',
  },
  {
  ...
  {
    question: "Este sigură transmiterea datelor mele personale prin Carvizio?",
    answer: 
    'Da, securitatea datelor este o prioritate pentru noi. Folosim protocoale de criptare moderne pentru a proteja toate datele transmise prin platformă și respectăm cu strictețe legislația GDPR privind protecția datelor personale.',
  },
  {
    question: "Ce tipuri de servicii auto pot solicita prin Carvizio?",
    answer: 
    'Poți solicita orice tip de serviciu auto, inclusiv întreținere de rutină (schimb ulei, filtre), reparații mecanice, servicii de caroserie, diagnosticare computerizată, verificare sau pregătire ITP, montare accesorii, și multe altele.',
  }
];
...
export default function FAQ() {
  ...
  // Pregătirea datelor structurate pentru Schema.org
  const faqSchema = {
    type: 'FAQ' as const,
    data: {
      questions: faqs
  ...
  return (
    <section id="faq" className="bg-white py-16">
      {/* Date structurate pentru FAQ folosind Schema.org */}

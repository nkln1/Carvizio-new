...
export function NavigationItems({
  ...
  const navigationItems: NavigationItem[] = [
    { id: "requests", label: "Cereri", icon: <FileText className="h-4 w-4" /> },
    {
      id: "offers",
    ...
    { id: "car", label: "Mașini", icon: <Car className="h-4 w-4" /> },
    { 
      id: "messages", 
      label: "Mesaje",
    ...
    { id: "profile", label: "Cont", icon: <User className="h-4 w-4" /> },
  ];
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              {navigationItems.map((item) => (
                ...
                >
                  <div className="flex items-center">
                    {item.icon}
                    <span className="lg:inline ml-1">{item.label}</span>
                  </div>

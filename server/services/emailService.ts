  ...
  public static async sendNewRequestNotification(
    ...
    try {
      ...
      if (!serviceProvider.email) {
        console.error(`❌ Date furnizor de servicii invalide - email lipsă:`, serviceProvider);
        return false;
      }
...
`;
  ...
  /**
   * Comentat a doua implementare de sendNewMessageNotificationToClient
   * Metodă dublată - folosim prima implementare de la linia 639
   */
}
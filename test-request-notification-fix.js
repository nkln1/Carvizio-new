...
/**
 * Script de test pentru a verifica notificările de cereri noi
 * Rulează direct metoda EmailService.sendNewRequestNotification 
 * pentru un service provider specific
 */
...
async function main() {
  console.log('=== TEST NOTIFICARE EMAIL PENTRU CERERE NOUĂ (FIX) ===\n');
